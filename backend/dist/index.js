...
const fakturownia_1 = __importDefault(require("./routes/fakturownia"));
...
app.use('/api/calculations', calculations_1.default);
app.use('/api/fakturownia', fakturownia_1.default);
